...
def get_config():
    ...
    parser.add_argument("--n_rollout_threads", type=int,
                        default=2, help="Number of parallel envs for training rollouts")
    parser.add_argument("--num_env_steps", type=int, default=10e6,
                        help='Number of environment steps to train (default: 10e6)')
    parser.add_argument("--episode_length", type=int,
                        default=200, help="Max length for any episode")
    parser.add_argument("--decision_step", type=int,
                        default=3, help="the gap of decision")

    # env
    parser.add_argument("--env_name", type=str,
                        default='battle', help="specify the name of environment")
    parser.add_argument("--n_eval_rollout_threads", type=int, default=1,
                        help="Number of parallel envs for evaluating rollouts")
    parser.add_argument("--enable_algorithm_step", type=int, default=200,
                        help="after this step, agent will be controlled by algorithm")
