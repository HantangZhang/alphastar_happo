import torch
import numpy as np
from baiduagent.baidu.algorithms.utils.utils.util import update_linear_schedule
from baiduagent.baidu.algorithms.utils.utils.util import get_shape_from_obs_space, get_shape_from_act_space
from baiduagent.baidu.algorithms.utils.util import check
from baiduagent.baidu.algorithms.mat.algorithm.ma_transformer import MultiAgentTransformer
...
class TransformerPolicy:
    ...
    def get_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, masks, available_actions=None,
        ...
        cent_obs = cent_obs.reshape(-1, self.num_agents, self.share_obs_dim) #[1,5,163]
