...
class ReplayBuffer(object):
    ...
    def __init__(self, args, obs_shape, share_obs_shape, act_space):
        ...
        self.available_actions = np.ones((self.episode_length + 1, self.n_rollout_threads, 6),
                                         dtype=np.float32)
    ...
    def compute_returns(self, next_value, value_normalizer=None):
        '''
        绝对是否使用proper time limits，区别是是否会使用bad mask

        :param next_value:
        :param value_normalizer:
        :return:
        '''
